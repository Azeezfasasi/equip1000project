        ...
        <div className="courses-content mobile-course-content">
            <div className="main-screen">
                ...
                <div className="microsoft-office-suite-description">
                    <p>
                    <span className="one">
                        Ready to unlock the full potential of Microsoft Excel?
                        <br />
                    </span>
                    <span className="two">
                ...
                <div className="listed-courses top-course">
                    <br />
                    <br />
                    <Link to="/lms/courses/microsoftofficetools/microsoftexcelcourse" href="microsoft-excel-course.html">Start Course</Link>
                </div>
                </div>
            </div>
        </div>
